...
/*
@Entity annotation tells Spring that the Movie class which is simply a POJO (Plain Old Java Object) which should be persisted on the database.
 */
@Entity
public class Movie {

    /*
    @Id annotation makes the id field the primary key of the movie table when it is persisted on the database.
